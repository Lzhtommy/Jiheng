...
const html = fs.readFileSync(path.join(root, 'app', 'static', 'procurement-journey.html'), 'utf8');
const stateScript = fs.readFileSync(path.join(root, 'app', 'static', 'world-state.js'), 'utf8');
